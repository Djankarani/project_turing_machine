        ...
        while (isRunning) {
            ...
            switch (cmd) {
                ...
                case "newtm":
                    ...
                    else System.out.println("Created new empty machine: " + parts[1]);
                    break;

                case "addstate":
                    if (parts.length < 3) System.out.println("Usage: addstate <id> <state>");
                    else System.out.println("Added state '" + parts[2] + "' to machine " + parts[1]);
                    break;
                ...
                case "addtrans":
                    if (parts.length < 7) {
                        ...
                        System.out.println("Transition added for " + parts[1] + ": (" + parts[2] + "," + parts[3] + ") -> (" + parts[4] + "," + parts[5] + "," + parts[6] + ")");
                    }
                    break;
